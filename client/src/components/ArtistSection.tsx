...
export default function ArtistSection() {
  return (
    <section className="py-36 sm:py-44 overflow-hidden" style={{ background: '#0b0b0b' }}>
      <div className="max-w-6xl mx-auto px-6 sm:px-10">

        {/* Artist bio — asymmetric grid */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-32 sm:mb-40">
          {/* Photo */}
          <motion.div
          ...
          >
            ...
            <div className="space-y-5 leading-relaxed" style={{ fontSize: '1.125rem', lineHeight: 1.8, color: '#7a7a7a' }}>
              <p>
        ...
        >
            ...
            {STEPS.map((step, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <p style={{ fontSize: '1.0625rem', lineHeight: 1.7, color: '#7a7a7a' }}>
                    {step.desc}
                  </p>
                </div>
              </motion.div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <p style={{ fontSize: '1rem', color: '#555' }}>Respuesta en menos de 24 horas.</p>
          </div>
        </motion.div>
      </div>
    </section>
