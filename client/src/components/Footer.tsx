 ...
 * Rediseño: texto más grande, más espacio, logo Digital Atlas más prominente
 */
      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-10 py-16 sm:py-20 text-center">
        ...
        <div className="flex flex-col items-center mb-10">
          <img
            ...
            style={{ filter: 'drop-shadow(0 0 14px rgba(191,161,90,0.3))' }}
          />
          <h3
            className="text-2xl font-bold tracking-widest uppercase mb-1.5"
            style={{ fontFamily: 'Playfair Display, serif' }}
          >
            <span style={{ color: '#f0ede8' }}>ABRAHAM </span>
            <span style={{ color: '#bfa15a' }}>TATTOO CR</span>
          </h3>
          <p className="text-sm text-[#5a5a5a] tracking-[0.2em] uppercase">
            {content.studio.tagline}
          </p>
        </div>

        {/* Bio */}
        <p className="text-base text-[#5a5a5a] leading-relaxed mb-10 max-w-sm mx-auto">
        ...
        {/* Location & Schedule */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-12 text-left max-w-lg mx-auto">
          {/* Schedule */}
          <div>
            <div className="flex items-center gap-2 mb-5">
              <Clock size={14} style={{ color: '#bfa15a' }} />
            ...
            <div className="space-y-2.5">
              ...
              <div className="flex justify-between text-sm pt-2.5" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          ...
          <div>
            <div className="flex items-center gap-2 mb-5">
              <MapPin size={14} style={{ color: '#bfa15a' }} />
        ...
        {/* Bottom */}
        <div className="flex flex-col items-center gap-5" style={{ borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '2rem' }}>
          <p className="text-sm" style={{ color: '#3a3a3a' }}>
            {content.footer.copyright}
          </p>

          {/* Digital Atlas — más grande y prominente */}
          <a
          ...
          >
            <span className="text-xs uppercase tracking-[0.2em] transition-colors group-hover:text-[#6a6a6a]" style={{ color: '#4a4a4a' }}>
              Powered by
            </span>
            <img
              ...
              onMouseEnter={e => { (e.target as HTMLImageElement).style.filter = 'brightness(0) invert(0.8)'; }}
              onMouseLeave={e => { (e.target as HTMLImageElement).style.filter = 'brightness(0) invert(0.5)'; }}
            />
            <span className="text-sm font-semibold transition-colors group-hover:text-[#8a8a8a]" style={{ color: '#4a4a4a' }}>Digital Atlas</span>
          </a>
        </div>
      </div>
    </footer>
